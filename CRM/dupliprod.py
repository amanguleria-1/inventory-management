...
class productClass:
    def __init__(self, root):
        ...
        lbl_product_name = Label(product_Frame, text="Product Name", font=(
            "SF Pro Rounded", 15), bg="white", fg="black").place(x=30, y=140)
        ...
        txt_name = Entry(product_Frame, textvariable=self.var_name,  font=(
            "SF Pro Rounded", 12), bg="lightyellow").place(x=150, y=140, width=200)
...
# ==================Product Details
        ...
        self.product_table = ttk.Treeview(product_Frame, columns=(
            "pid",  "Category",  "name", "price", "qty", "status"), yscrollcommand=scrolly.set, xscrollcommand=scrollx.set)
