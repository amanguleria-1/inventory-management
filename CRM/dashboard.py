...
from customers import customerClass
...
class CRM:
    def __init__(self, root):
        ...
        LeftMenu.place(x=0, y=102, width=250, height=665)
        ...
        btn_employee = Button(LeftMenu, text="Employees", command=self.employee, image=self.icon_side, compound=LEFT, anchor="w", padx=20, font=(
        ...
        btn_product = Button(LeftMenu, text="Products", command=self.product, image=self.icon_side, compound=LEFT, anchor="w", padx=20, font=(
            "SF Pro Rounded", 20, "bold"), bg="white", bd=3, cursor="hand2").pack(side=TOP, fill=X)
        btn_sales = Button(LeftMenu, text="Sales", command=self.sales, image=self.icon_side, compound=LEFT, anchor="w", padx=20, font=(
            "SF Pro Rounded", 20, "bold"), bg="white", bd=3, cursor="hand2").pack(side=TOP, fill=X)
        btn_stockEntry = Button(LeftMenu, text="Stock Purchase", command=self.supBill, image=self.icon_side, compound=LEFT, anchor="w", padx=20, font=(
            "SF Pro Rounded", 20, "bold"), bg="white", bd=3, cursor="hand2").pack(side=TOP, fill=X)
        btn_SuppPayment = Button(LeftMenu, text="Stock payment",  image=self.icon_side, compound=LEFT, anchor="w", padx=20, font=(
            "SF Pro Rounded", 20, "bold"), bg="white", bd=3, cursor="hand2").pack(side=TOP, fill=X)
        btn_customer = Button(LeftMenu, text="Customers", command=self.customer, image=self.icon_side, compound=LEFT, anchor="w", padx=20, font=(
            "SF Pro Rounded", 20, "bold"), bg="white", bd=3, cursor="hand2").pack(side=TOP, fill=X)
        ...
        self.lbl_customers = Label(
            self.root, text="Total Customers\n[ 0 ]", bd=5, relief=RIDGE, bg="#FAD02C", fg="black", font=("SF Pro Rounded", 20, "bold"))
