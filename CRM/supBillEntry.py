...
class supBillEntry:
    def __init__(self, root):
        ...
        # TITLE_______
        title = Label(product_Frame, text="Recieving Invoice", font=(
            "SF Pro Rounded", 20, "bold"), bg="#0f4d7d", fg="white").pack(side=TOP, fill=X)

        # Column 1--------------
        lbl_invoice_number = Label(product_Frame, text="Invoice number", font=(
            "SF Pro Rounded", 15), bg="white", fg="black").place(x=30, y=40)
        ...
        lbl_category = Label(product_Frame, text="Category", font=(
            "SF Pro Rounded", 15), bg="white", fg="black").place(x=30, y=130)
        lbl_product_name = Label(product_Frame, text="Product Name", font=(
            "SF Pro Rounded", 15), bg="white", fg="black").place(x=30, y=180)
        lbl_price = Label(product_Frame, text="Price", font=(
            "SF Pro Rounded", 15), bg="white", fg="black").place(x=30, y=220)
        lbl_quantity = Label(product_Frame, text="Quantity", font=(
            "SF Pro Rounded", 15), bg="white", fg="black").place(x=30, y=260)

        # Column 2--------------
        txt_invoice = Entry(product_Frame, textvariable=self.var_invoice_number,  font=(
            "SF Pro Rounded", 12), bg="lightyellow").place(x=150, y=40, width=200)
        cmb_supplier = ttk.Combobox(product_Frame, values=self.sup_list, textvariable=self.var_supplier, state="readonly", justify=CENTER, font=(
            "SF Pro Rounded", 12))
        cmb_supplier.place(x=150, y=80, width=200)
        ...
        cmb_cat = ttk.Combobox(product_Frame, values=self.cat_list, textvariable=self.var_cat, state="readonly", justify=CENTER, font=(
            "SF Pro Rounded", 12))
        cmb_cat.place(x=150, y=130, width=200)
        cmb_cat.current(0)
        ...
        cmb_product = ttk.Combobox(product_Frame, values=self.prod_list, textvariable=self.var_prod, state="readonly", justify=CENTER, font=(
            "SF Pro Rounded", 12))
        cmb_product.place(x=150, y=180, width=200)
        ...
        cmb_quantUnit = ttk.Combobox(product_Frame, values=self.quantUnit_list, textvariable=self.var_quantUnit, state="readonly", justify=CENTER, font=(
            "SF Pro Rounded", 12))
        cmb_quantUnit.place(x=360, y=260, width=80)
        cmb_quantUnit.current(0)

        txt_price = Entry(product_Frame, textvariable=self.var_price,  font=(
            "SF Pro Rounded", 12), bg="lightyellow").place(x=150, y=220, width=200)
...
# ===============================================Cart============
        ...
        billFrame.place(x=490, y=10, width=480, height=780)
    ...
    def bill_top(self):
        ...
        Supplier Invoice number: {self.var_invoice_number.get()}
