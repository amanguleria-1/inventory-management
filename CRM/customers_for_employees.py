...
# row1
 ...
 # row6
        ...
        self.txt_new_address = Entry(self.root, textvariable=self.var_address, font=(
...
# Buttons
        btn_add = Button(self.root, text="Save", command=self.add, font=(
            "SF Pro Rounded", 12), bg="#E3CF57", fg="black", cursor="hand2").place(x=180, y=420, width=110, height=30)
        btn_update = Button(self.root, text="Update", command=self.update, font=(
            "SF Pro Rounded", 12), bg="#E3CF57", fg="black", cursor="hand2").place(x=300, y=420, width=110, height=30)
        btn_clear = Button(self.root, text="Clear", command=self.clear, font=(
            "SF Pro Rounded", 12), bg="#E3CF57", fg="black", cursor="hand2").place(x=420, y=420, width=110, height=30)
